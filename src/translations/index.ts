  ...
  de: {
    ...
    pricing: {
      ...
      free: {
        ...
        games: '1 Spiel',
        features: [
          'Automatische Posts (2 pro Spiel: Ankündigung + Resultat)',
          'Kein eigenes Branding',
          'Kein Template-Upload',
          'Teamwechsel nur alle 24 h',
      ...
      amateur: {
        ...
        periodYearly: '/Jahr',
        teams: 'bis 3 Teams',
        templates: 'bis 3 eigene Vorlagen',
        games: '1 Spiel (via API)',
        features: [
          'Alle Free-Features',
          'Eigene Farb- & Logoanpassung',
          'Zugriff auf Verbandsdaten (Spielpläne)',
          'Standard-Branding (kleines "Made with KANVA")',
          'Manuelles oder automatisches Posting (Social Export)',
        ],
        cta: 'Jetzt starten',
        popular: false,
      },
      pro: {
        ...
        periodYearly: '/Jahr',
        teams: 'bis 6 Teams',
        templates: 'bis 6 eigene Vorlagen',
        games: 'bis zu 2 Spiele (via API)',
        features: [
          'Alle Amateur-Features',
          'Eigene Templates & Farben',
          'Club Branding (ohne KANVA-Logo)',
          'Automatischer Social Export (Instagram, Facebook, WhatsApp)',
          'Zugriff auf Premium-Designs (Matchday, Scoreboard, Highlight)',
          'Statistik & Insights',
        ],
        cta: 'Jetzt starten',
        popular: true,
      ...
      premium: {
        ...
        features: [
          'Alle Pro-Features',
          'White Label (kein KANVA-Branding)',
          'Multi-Admin-Zugänge',
          'API-Integration für Verbände',
          'Automatischer Upload & Scheduling',
          'Priority Support',
          'Individuelle Vorlagen-Erstellung durch KANVA-Team möglich',
        ],
