...
const KANVA_TEMPLATE_ID = 'ccc8f1da-de51-42a5-b91d-39fc2a837b15'
...
<a href="https://getkanva.io/studio/${game.sport}/${game.club_id}/${game.team_id}/${game.id}?template=${KANVA_TEMPLATE_ID}" target="_blank" style="font-size: 16px; font-family: 'Maven Pro', Arial, sans-serif; color: #FFFFFF; text-decoration: none; padding: 12px 20px; border-radius: 25px; border: 1px solid #015afe; display: inline-block;">Ankündigung erstellen</a>
</td>
</tr>
</table>
</td>
...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Maven Pro', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">In ${userDaysBefore} Tagen ${userData.games.length === 1 ? 'steht ein Spiel' : 'stehen ' + userData.games.length + ' Spiele'} an!</div>
...
<img alt="Logo" src="https://getkanva.io/logo_dark_wide.png" width="40" height="40" style="display: block; width: 200px; max-width: 200px; min-width: 40px; font-family: 'Maven Pro', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
</a>
</td>
</tr>
</table>
...
<p style="margin: 0;">In ${userDaysBefore} Tagen ${userData.games.length === 1 ? 'steht ein Spiel' : 'stehen ' + userData.games.length + ' Spiele'} deiner Teams an! Jetzt ist der perfekte Zeitpunkt, um eine mitreissende Spielankündigung zu erstellen und deine Fans zu mobilisieren.</p>
</td>
</tr>
${gamesListHtml}
</table>
